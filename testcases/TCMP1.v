task run_test();
	...
	begin
		...
		$display("\n========== Write 32'h0000_0000 =============");
		test_bench.apb_write(12'h10, 32'h0000_0000);
		test_bench.apb_read(12'h10, out_rd);
		...
		$display("\n========== Write 32'hffff_ffff =============");
		test_bench.apb_write(12'h10, 32'hffff_ffff);
		test_bench.apb_read(12'h10, out_rd);
		if (out_rd == 32'hffff_ffff) begin
		...
		$display("\n========== Write 32'h5555_5555 =============");
		test_bench.apb_write(12'h10, 32'h5555_5555);
		test_bench.apb_read(12'h10, out_rd);
		...
		$display("\n========== Write 32'haaaa_aaaa =============");
		test_bench.apb_write(12'h10, 32'haaaa_aaaa);
		test_bench.apb_read(12'h10, out_rd);
		...
		test_bench.apb_write(12'h10, 32'h3333_3333);
		test_bench.apb_read(12'h10, out_rd);
		if (out_rd == 32'haaaa_aaaa) begin
		...
		test_bench.apb_write(12'h10, 32'h4444_4444);
		test_bench.apb_read(12'h10, out_rd);
		...
		test_bench.apb_write(12'h10, 32'h6666_6666);
		test_bench.apb_read(12'h10, out_rd);
		...
		test_bench.apb_write(12'h10, 32'h7777_7777);
		test_bench.apb_read(12'h10, out_rd);
		...
		test_bench.apb_write(12'h10, 32'h8888_8888);
		test_bench.apb_read(12'h10, out_rd);
		...
		test_bench.apb_write(12'h10, 32'h1111_1111);
		test_bench.apb_read(12'h10, out_rd);
		...
		test_bench.apb_write(12'h10, 32'h2222_2222);
		test_bench.apb_read(12'h10, out_rd);
